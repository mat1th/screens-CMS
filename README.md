...
The app has an API. You can get call the API on `api/content/:contentId`. You will get all the content from the poster id. The object that will be returned is:
